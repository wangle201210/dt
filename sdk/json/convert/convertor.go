// based on the work of https://github.com/ChimeraCoder/gojson
package convert
...
func Generate(data string, structName, pkgName string, tags []string, subStruct bool, convertFloats bool) (string, error) {
	...
	err := json.Unmarshal([]byte(data), &iresult)
	...
	default:
		return "", fmt.Errorf("unexpected type: %T", iresult)
	}
